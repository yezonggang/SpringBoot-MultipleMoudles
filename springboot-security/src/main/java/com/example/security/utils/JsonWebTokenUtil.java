...
import com.example.security.config.security.JsonWebTokenProperty;
...
public class JsonWebTokenUtil {
    ...
    public String generateRefreshToken(UserDetails details, String roles){
        logger.info(String.format("%s,%s,%s,%s",jsonWebTokenProperty.getSecret(),jsonWebTokenProperty.getExpiration(),jsonWebTokenProperty.getHeader(),jsonWebTokenProperty.getRefresh_expiration()));
        Map<String,Object> claims = new HashMap<>();
        claims.put("sub", details.getUsername());
        claims.put("create",new Date());
        claims.put("role",roles);
