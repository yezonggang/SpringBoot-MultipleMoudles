...
public class LoginController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "client_id", defaultValue = "client-app", value = "Oauth2客户端ID", required = true),
    ...
    public Object postAccessToken(@ApiIgnore Principal principal,
         ...
         */
        log.info("参数：{}",JSONUtils.toJSONString(parameters));
        ...
        return ResponseData.fail(ApiError.from(ApiErrorEnum.HAVE_NO_TOKEN));
    }
